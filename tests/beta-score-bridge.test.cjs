...
test('ingestion triggers bounded recompute and score reads derive ownership from web auth', () => {
  ...
  assert.match(edge, /recomputeDates\(admin, String\(session\.canonical_user_id\), affectedDates\)/u);
