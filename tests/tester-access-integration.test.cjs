...
test('Web tester UI has manual selection, config-driven links, and no fake href', () => {
  ...
  assert.match(html, /ANDROID_BETA_APK_URL:"https:\/\/github\.com\/d0252422-oss\/haelth-companion\/releases\/download\/android-beta-v0\.1\.0-beta\.7\/health-sync-companion-beta-0\.1\.0-beta\.7-debug\.apk"/u);
  assert.match(html, /ANDROID_BETA_APK_VERSION:"0\.1\.0-beta\.7-debug"/u);
  assert.match(html, /ANDROID_BETA_APK_SHA256:"029c7b5facb54bd9b7ff99fc24f05d925f6f80ecd12c8227af4cd1d41498fa21"/u);
